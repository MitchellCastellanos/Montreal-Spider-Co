/** ISO 3166-1 alpha-2 country code → English display name, for admin analytics only. */
export const COUNTRY_NAMES: Record<string, string> = {
  ...
  BJ: "Benin", BM: "Bermuda", BN: "Brunei", BO: "Bolivia", BR: "Brazil", BS: "Bahamas", BT: "Bhutan",
  ...
  CO: "Colombia", CR: "Costa Rica", CU: "Cuba", CV: "Cabo Verde", CY: "Cyprus", CZ: "Czechia",
...
/** Regional-indicator flag emoji from an ISO 3166-1 alpha-2 code. Empty string if not a valid 2-letter code. */
