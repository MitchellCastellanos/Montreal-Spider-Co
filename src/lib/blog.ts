    ...
    sections: [
      {
        ...
        body: [
          {
            en: "\"How long does a tarantula live?\" doesn't have one answer, and that's the first thing that surprises new keepers. Depending on the species and whether you're holding a male or a female, the honest range runs from under two years to over three decades in the same family of animals. It's less like asking how long a \"dog\" lives and more like asking how long a \"mammal\" lives — the category is doing a lot of hiding.",
            fr: "« Combien de temps vit une mygale? » n'a pas une seule réponse, et c'est la première chose qui surprend les nouveaux éleveurs. Selon l'espèce et selon qu'on parle d'un mâle ou d'une femelle, la fourchette honnête va de moins de deux ans à plus de trois décennies, au sein de la même famille d'animaux. C'est moins comme demander combien de temps vit un « chien » et plus comme demander combien de temps vit un « mammifère » — la catégorie cache énormément de variation.",
          },
        ],
      },
      {
